...
# src/chacha20.c:103: void chacha20(chacha_buf *output, const u32 input[16]){
	...
	li	t0,10		# ivtmp_6,
.L2:
# src/chacha20.c:130:         QUARTERROUND(0, 4, 8, 12);
	addw	s5,t1,s5	# x_I_lsm.4, tmp247, x_I_lsm.5
# src/chacha20.c:131:         QUARTERROUND(1, 5, 9, 13);
	addw	t5,t5,t3	# ret, tmp271, x_I_lsm.8
# src/chacha20.c:132:         QUARTERROUND(2, 6, 10, 14);
	addw	s2,a6,s2	# x_I_lsm.12, tmp295, x_I_lsm.13
# src/chacha20.c:133:         QUARTERROUND(3, 7, 11, 15);
...
# src/chacha20.c:130:         QUARTERROUND(0, 4, 8, 12);
#APP
# 130 "src/chacha20.c" 1
	roriw a2, a2, 16	# ret, tmp251,
# 0 "" 2
# src/chacha20.c:131:         QUARTERROUND(1, 5, 9, 13);
# 131 "src/chacha20.c" 1
...
# src/chacha20.c:132:         QUARTERROUND(2, 6, 10, 14);
#APP
# 132 "src/chacha20.c" 1
	roriw a4, a4, 16	# ret, tmp299,
# 0 "" 2
# src/chacha20.c:133:         QUARTERROUND(3, 7, 11, 15);
# 133 "src/chacha20.c" 1
...
# src/chacha20.c:141:         QUARTERROUND(2, 7, 8, 13);
...
# 0 "" 2
# src/chacha20.c:142:         QUARTERROUND(3, 4, 9, 14);
#NO_APP
	addw	t4,t4,t1	# ret, tmp415, tmp331
# src/chacha20.c:140:         QUARTERROUND(1, 6, 11, 12);
...
# 0 "" 2
# src/chacha20.c:139:         QUARTERROUND(0, 5, 10, 15);
#NO_APP
...
# src/chacha20.c:140:         QUARTERROUND(1, 6, 11, 12);
#APP
# 140 "src/chacha20.c" 1
	roriw s6, a2, 16	# ret, tmp371,
# 0 "" 2
# src/chacha20.c:142:         QUARTERROUND(3, 4, 9, 14);
# 142 "src/chacha20.c" 1
...
# src/chacha20.c:139:         QUARTERROUND(0, 5, 10, 15);
#APP
# 139 "src/chacha20.c" 1
	roriw a7, a5, 16	# ret, tmp347,
# 0 "" 2
# src/chacha20.c:141:         QUARTERROUND(2, 7, 8, 13);
# 141 "src/chacha20.c" 1
...
# src/chacha20.c:129:     for (i = 0; i < 20; i+=2) {
