...
# src/chacha20.c:59: {
	...
	li	t0,10		# ivtmp_6,
.L2:
# src/chacha20.c:76:         QUARTERROUND(0, 4, 8, 12);
	addw	s5,t1,s5	# x_I_lsm.4, tmp247, x_I_lsm.5
# src/chacha20.c:77:         QUARTERROUND(1, 5, 9, 13);
	addw	t5,t5,t3	# ret, tmp271, x_I_lsm.8
# src/chacha20.c:78:         QUARTERROUND(2, 6, 10, 14);
	addw	s2,a6,s2	# x_I_lsm.12, tmp295, x_I_lsm.13
# src/chacha20.c:79:         QUARTERROUND(3, 7, 11, 15);
...
# src/chacha20.c:82:         QUARTERROUND(2, 7, 8, 13);
...
# 0 "" 2
# src/chacha20.c:83:         QUARTERROUND(3, 4, 9, 14);
#NO_APP
	addw	t4,t4,t1	# ret, tmp415, tmp331
# src/chacha20.c:81:         QUARTERROUND(1, 6, 11, 12);
...
# 0 "" 2
# src/chacha20.c:80:         QUARTERROUND(0, 5, 10, 15);
#NO_APP
...
# src/chacha20.c:75:     for (i = 20; i > 0; i -= 2) {
...
# src/chacha20.c:75:     for (i = 20; i > 0; i -= 2) {
	...
	sw	t2,16(sp)	# ret, x[4]
# src/chacha20.c:87:     asm volatile(
#APP
# 87 "src/chacha20.c" 1
